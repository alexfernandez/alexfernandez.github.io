...
Building a solar panel requires giving the cells some support,
protection from the elements and electrical connections;
...
```
L = 8.38 m³ × (1.3 - 0.070) kg/m³ ≈ 10.3 kg.
```

So we still have more than 2 kg to spare, right?
But air density of 1.3 kg/m³ is only reached at unrealistic temperatures of 0 °C!
...
so there is a sweet spot in there somewhere.
